...
namespace traverse {
    ...
    {
        return Private::elements_impl<0, std::tuple_size<T>::value, T&>::visit(
            t, visitor);
    }
    ...
    {
        return Private::elements_impl<0, std::tuple_size<T>::value, const T&>::visit(
            t, visitor);
    }
    ...
    {
        return Private::elements_impl<0, std::tuple_size<T>::value, T>::visit_if(
            t, visitor);
    }
    ...
    {
        return Private::elements_impl<0, std::tuple_size<T>::value, const T&>::
            visit_if(t, visitor);
    }
    ...
    {
        return Private::combinations_impl<0, 1, std::tuple_size<T>::value, T&>::visit(
            t, visitor);
    }
    ...
    U combinations(T&& t, U visitor)
    {
        return Private::combinations_impl<0, 1, std::tuple_size<T>::value, T&&>::
            visit(t, visitor);
    }
    ...
    {
        return Private::combinations_impl<0, 1, std::tuple_size<T>::value, const T&>::
            visit(t, visitor);
    }
    ...
    {
        return Private::pairs_impl<2, std::tuple_size<T>::value, T&>::visit(t,
            visitor);
    }
    ...
    {
        return Private::pairs_impl<2, std::tuple_size<T>::value, const T&>::visit(
            t, visitor);
    }
    ...
    {
        return Private::pairs_impl<2, std::tuple_size<T>::value, T&>::visit_if(
            t, visitor);
    }
    ...
    {
        return Private::pairs_impl<2, std::tuple_size<T>::value, const T&>::visit_if(
            t, visitor);
    }
    ...
    {
        return Private::reduce_impl<2, std::tuple_size<U>::value, T, U&>::visit(
            t, visitor);
    }
    ...
    template <class T, class U, class V>
    std::tuple<T, V>
    reduce(const U& t, V visitor)
    {
        return Private::reduce_impl<2, std::tuple_size<U>::value, T, const U&>::visit(
            t, visitor);
    }
    ...
    {
        return Private::parallel_impl<0, std::tuple_size<T>::value, T&, T&>::visit(
            lhs, rhs, visitor);
    }
    ...
    {
        return Private::parallel_impl<0, std::tuple_size<T>::value, T&, const T&>::
    ...
    {
        return Private::parallel_impl<0, std::tuple_size<T>::value, const T&, T&>::
            visit(lhs, rhs, visitor);
    }
    ...
    {
        return Private::
            parallel_impl<0, std::tuple_size<T>::value, const T&, const T&>::visit(
                lhs, rhs, visitor);
    }
    ...
    {
        return Private::parallel_impl<0, std::tuple_size<T>::value, T&, U&>::visit(
            lhs, rhs, visitor);
    }
    ...
    {
        return Private::parallel_impl<0, std::tuple_size<T>::value, T&, const U&>::
            visit(lhs, rhs, visitor);
    }
    ...
    {
        return Private::parallel_impl<0, std::tuple_size<T>::value, const T&, U&>::
            visit(lhs, rhs, visitor);
    }
    ...
    {
        return Private::
            parallel_impl<0, std::tuple_size<T>::value, const T&, const U&>::visit(
                lhs, rhs, visitor);
    }
    ...
    {
        return Private::parallel_impl<0, std::tuple_size<T>::value, T&, T&>::visit_if(
            lhs, rhs, visitor);
    }
    ...
    V parallel_if(T& lhs, T&& rhs, V visitor)
    {
        return Private::parallel_impl<0, std::tuple_size<T>::value, T&, T&&>::
            visit_if(lhs, rhs, visitor);
    }
    ...
    {
        return Private::
            parallel_impl<0, std::tuple_size<T>::value, const T&, const T&>::visit_if(
                lhs, rhs, visitor);
    }
    ...
    {
        return Private::parallel_impl<0, std::tuple_size<T>::value, T&, U&>::visit_if(
            lhs, rhs, visitor);
    }
    ...
    V parallel_if(T& lhs, U&& rhs, V visitor)
    {
        return Private::parallel_impl<0, std::tuple_size<T>::value, T&, U&&>::
            visit_if(lhs, rhs, visitor);
    }
    ...
    {
        return Private::
            parallel_impl<0, std::tuple_size<T>::value, const T&, const U&>::visit_if(
                lhs, rhs, visitor);
    }
...
#pragma mark - combinations_binary_impl
        ...
        struct combinations_binary_impl {
            ...
            typedef combinations_binary_impl<l_index, r_index + 1, l_size, r_size, T, U>
                permutation;
        ...
        struct combinations_binary_impl<M, N, O, N, T, U> {
            ...
            typedef combinations_binary_impl<l_index + 1, 0, l_size, r_size, T, U>
                permutation;
